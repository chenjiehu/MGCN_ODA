...
from Dataset import SOURCE_DATA, TARGET_DATA
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', default='./save/step1/RA/10way_5shot')
    parser.add_argument('--save-path', default='./save/step2/RA/10way_5shot')
